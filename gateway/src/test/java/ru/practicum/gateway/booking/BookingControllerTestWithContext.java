...
class BookingControllerTestWithContext {
    ...
    void saveNewBooking() throws Exception {
        ...
        ResponseEntity<Object> responseEntityBookingDto = new ResponseEntity<>(mapper.writeValueAsString(bookingDto), HttpStatus.OK);

        when(bookingClient.create(saveBookingRequest, bookerId))
                .thenReturn(responseEntityBookingDto);
    ...
    void approve() throws Exception {
        ...
        ResponseEntity<Object> responseEntityBookingDto = new ResponseEntity<>(mapper.writeValueAsString(bookingDtoApproved), HttpStatus.OK);

        when(bookingClient.approve(1L, true, 4L))
                .thenReturn(responseEntityBookingDto);
    ...
    void getById() throws Exception {
        ...
        when(bookingClient.findById(1L, bookerId))
                .thenReturn(responseEntityBookingDto);
    ...
    void getByUserId() throws Exception {
        ...
        ResponseEntity<Object> responseEntityBookingDto = new ResponseEntity<>(mapper.writeValueAsString(bookingDtoList), HttpStatus.OK);

        when(bookingClient.findByUserId(2L, "ALL"))
                .thenReturn(responseEntityBookingDto);
    ...
    void getByOwnerId() throws Exception {
        ...
        when(bookingClient.findByOwnerId(ownerId, "ALL"))
                .thenReturn(responseEntityBookingDto);
