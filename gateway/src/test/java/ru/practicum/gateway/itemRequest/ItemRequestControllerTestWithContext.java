...
class ItemRequestControllerTestWithContext {
    ...
    void saveNewRequest() throws Exception {
        ...
        ResponseEntity<Object> responseEntityRequestDto = new ResponseEntity<>(mapper.writeValueAsString(itemRequestDto), HttpStatus.OK);

        when(requestClient.create(saveItemRequest, userId))
                .thenReturn(responseEntityRequestDto);
    ...
    void findByRequestorId() throws Exception {
        ...
        ResponseEntity<Object> responseEntityRequestDto = new ResponseEntity<>(mapper.writeValueAsString(requestDtoList), HttpStatus.OK);

        when(requestClient.findByRequestorId(userId))
                .thenReturn(responseEntityRequestDto);
    ...
    void findAll() throws Exception {
        ...
        when(requestClient.findAll(userId2))
                .thenReturn(responseEntityRequestDto);
    ...
    void findByIdAndOwnerId() throws Exception {
        ...
        when(requestClient.findByIdAndOwnerId(requestId, ownerId))
                .thenReturn(responseEntityRequestDto);
