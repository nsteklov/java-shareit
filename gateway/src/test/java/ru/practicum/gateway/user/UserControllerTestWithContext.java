...
class UserControllerTestWithContext {
    ...
    void saveNewUser() throws Exception {
        ...
        ResponseEntity<Object> responseEntityUserDto = new ResponseEntity<>(mapper.writeValueAsString(userDto), HttpStatus.OK);

        when(userClient.create(any()))
                .thenReturn(responseEntityUserDto);
    ...
    void updateUser() throws Exception {
        ...
        when(userClient.update(any(), eq(1L)))
                .thenReturn(responseEntityUserDto);
    ...
    void getAllUsers() throws Exception {
        ...
        ResponseEntity<Object> responseEntityUserDto = new ResponseEntity<>(mapper.writeValueAsString(sourceUsers), HttpStatus.OK);

        when(userClient.getAll()).thenReturn(responseEntityUserDto);
